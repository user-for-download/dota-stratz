...
func Load(path string) (*Config, error) {
	...
	if cfg.RabbitMQ.Queues.MatchIDs == "" {
		return nil, fmt.Errorf("rabbitmq.queues.match_ids is required")
	}
	if cfg.RabbitMQ.Queues.RawMatches == "" {
		return nil, fmt.Errorf("rabbitmq.queues.raw_matches is required")
	}
	if cfg.Postgres.DSN == "" {
