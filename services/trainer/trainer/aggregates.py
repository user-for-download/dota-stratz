...
def populate_baseline_snapshot(cfg, conn) -> int:
    ...
    with conn.cursor() as cur:
        cur.execute(f"""
            ...
            INNER JOIN total_matches_pit tm ON tm.as_of_date = COALESCE(p.as_of_date, b.as_of_date) ORDER BY as_of_date, hero_id
